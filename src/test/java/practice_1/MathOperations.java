...
//1. Напишите класс practice_1.MathOperations
//        Условие:
//        Создайте класс practice_1.MathOperations с методами:
...
//Подсказки:
//        Класс practice_1.MathOperations: создай отдельные методы. Для деления обязательно использовать double-преобразование (x / (double)y), чтобы не было целочисленного деления.
