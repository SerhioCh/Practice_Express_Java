...
public class SuccessAddDeposit extends BaseTest {
    @BeforeAll
    ...
    public void addDepositToAccount() {
        ...
        softly.assertThat(alert.getText()).as("Amount is incorrect in alert").contains("$" + DEPOSIT_AMOUNT);
        softly.assertThat(alert.getText()).as("Account is incorrect in alert").contains(account.getAccountNumber());
        alert.accept();
